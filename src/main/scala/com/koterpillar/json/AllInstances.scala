...
trait AllInstances {
  ...
  implicit val intSchema: Schema[Int] = new Schema[Int] {
    ...
    override def codec: Prism[Json, Int] =
      Prism[Json, Int] { obj =>
        obj.asNumber.flatMap(_.toInt)
      }(Json.fromInt)
  }
  ...
  implicit val stringSchema: Schema[String] = new Schema[String] {
    ...
    override def codec: Prism[Json, String] =
      Prism[Json, String](_.asString)(Json.fromString)
  }

  implicit val booleanSchema: Schema[Boolean] = new Schema[Boolean] {
    override def schema: Json = boolean

    override def codec: Prism[Json, Boolean] =
      Prism[Json, Boolean](_.asBoolean)(Json.fromBoolean)
  }
}
